...
const CreatePoint = () => {
    ...
    useEffect(() => {
        ...
        axios.get<IBGEUFResponse[]>(`https://servicodados.ibge.gov.br/api/v1/localidades/estados/${selectedUF}/distritos`).then(response => {
            const cityDatas = response.data.map(city => {
                return ({id: city.id,
                    nome: city.nome
                })
            });
    ...
    function handleInputForms (event: ChangeEvent<HTMLInputElement>) {
    ...
    async function handleSubmit (event: FormEvent) {
        ...
        const data = new FormData();
            ...
            data.append('longtude', String(longitude));
